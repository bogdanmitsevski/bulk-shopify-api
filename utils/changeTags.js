...
let clothes_2 = ['Брюки-юбка', 'Брюки', 'Легінси', 'Леггинсы', 'Штани', 'Штаны', 'Шорти', 'Шорты', 'Бермуды', 'Кюлоты', 'Капри', 'Чиносы'];
let clothes_3 = ['Дублянка', 'Дубленка', 'Плащ', 'Пуховик', 'Тренч', 'Манто', 'Парка', 'Кабан', 'Шуба', 'Пальто-шарф', 'Накидка', 'Кейп', 'Куртка', 'Пальто', 'Ветровка'];
let clothes_4 = ['Джинси', 'Джинсы'];
let clothes_5 = ['Костюм', 'Смокинг'];
let clothes_6 = ['Піджак', 'Пиджак', 'Блейзер', 'Накидка', 'Жакет', 'Жилетка', 'Жилет'];
let clothes_7 = ['Сукня', 'Платье', 'Комбінезон', 'Комбинезон'];
let clothes_8 = ['Бомбер', 'Толстовка', 'Світшот', 'Свитшот', 'Худі', 'Худи', 'Лонгслив'];
let clothes_9 = ['Блуза', 'Бюстьє', 'Сорочка', 'Рубашка', 'Топ', 'Футболка', 'Поло', 'Боді', 'Боди', 'Майка-футболка', 'Майка', 'Корсет'];
...
let shoes_3 = ['Байкеры', 'Байкер', 'Черевики', 'Ботинки', 'Ботинок', 'Дезерти', 'Дезерты', 'Напівчеревики', 'Полуботинок', 'Челсі', 'Челси'];
...
let shoes_9 = ['Ботфорты', 'Ботфорт', 'Полусапог', 'Чоботи', 'Сапог-чулок', 'Сапоги', 'Сапог', 'Унты'];
