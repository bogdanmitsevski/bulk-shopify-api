let clothes_1 = ['Колготки', 'Плавки', 'Купальник', 'Шкарпетки', 'Носки', 'Труси', 'Трусы', 'Лиф', 'Чулки', 'Бікіні', 'Бикини', 'Білизна', 'Кафтан', 'колготки', 'плавки', 'купальник', 'шкарпетки', 'носки', 'труси', 'трусы', 'лиф', 'чулки', 'бікіні', 'бикини', 'білизна', 'кафтан'];
let clothes_2 = ['Брюки-юбка', 'Брюки', 'Легінси', 'Леггинсы', 'Штани', 'Штаны', 'Шорти', 'Шорты', 'Бермуды', 'Кюлоты', 'Капри', 'Чиносы', 'брюки-юбка', 'брюки', 'легінси', 'леггинсы', 'штани', 'штаны', 'шорти', 'шорты', 'бермуды', 'кюлоты', 'капри', 'чиносы'];
let clothes_3 = ['Дублянка', 'Дубленка', 'Плащ', 'Пуховик', 'Тренч', 'Манто', 'Парка', 'Кабан', 'Шуба', 'Пальто-шарф', 'Накидка', 'Кейп', 'Куртка', 'Пальто', 'Ветровка', 'дублянка', 'дубленка', 'плащ', 'пуховик', 'тренч', 'манто', 'парка', 'кабан', 'шуба', 'пальто-шарф', 'накидка', 'кейп', 'куртка', 'пальто', 'ветровка'];
let clothes_4 = ['Джинси', 'Джинсы', 'джинси', 'джинсы'];
let clothes_5 = ['Костюм', 'Смокинг', 'костюм', 'смокинг'];
let clothes_6 = ['Піджак', 'Пиджак', 'Блейзер', 'Накидка', 'Жакет', 'Жилетка', 'Жилет', 'піджак', 'пиджак', 'блейзер', 'накидка', 'жакет', 'жилетка', 'жилет'];
let clothes_7 = ['Сукня', 'Платье', 'Комбінезон', 'Комбинезон', 'сукня', 'платье', 'комбінезон', 'комбинезон'];
let clothes_8 = ['Бомбер', 'Толстовка', 'Світшот', 'Свитшот', 'Худі', 'Худи', 'Лонгслив', 'бомбер', 'толстовка', 'світшот', 'свитшот', 'худі', 'худи', 'лонгслив'];
let clothes_9 = ['Блуза', 'Бюстьє', 'Сорочка', 'Рубашка', 'Топ', 'Футболка', 'Поло', 'Боді', 'Боди', 'Майка-футболка', 'Майка', 'Корсет', 'блуза', 'бюстьє', 'сорочка', 'рубашка', 'топ', 'футболка', 'поло', 'боді', 'боди', 'майка-футболка', 'майка', 'корсет'];
let clothes_10 = ['Гольф', 'Джемпер', 'Кардиган', 'Светр', 'Свитер', 'Кофта', 'Туніка', 'Туника', 'Пончо', 'гольф', 'джемпер', 'кардиган', 'светр', 'свитер', 'кофта', 'туніка', 'туника', 'пончо'];
let clothes_11 = ['Спідниця', 'Юбка', 'спідниця', 'юбка'];

let shoes_1 = ['Босоніжки', 'Босоножки', 'Босоножек', 'босоніжки', 'босоножки', 'босоножек'];
let shoes_2 = ['Ботильйони', 'Ботильоны', 'Ботильон', 'ботильйони', 'ботильоны', 'ботильон'];
let shoes_3 = ['Байкеры', 'Байкер', 'Черевики', 'Ботинки', 'Ботинок', 'Дезерти', 'Дезерты', 'Напівчеревики', 'Полуботинок', 'Челсі', 'Челси', 'байкеры', 'байкер', 'черевики', 'ботинки', 'ботинок', 'дезерти', 'дезерты', 'напівчеревики', 'полуботинок', 'челсі', 'челси'];
let shoes_4 = ['Кеди', 'Кеды', 'Кросівки', 'Кроссовки', 'Кроссы', 'Снікерси', 'Сникерсы', 'Сникерс', 'кеди', 'кеды', 'кросівки', 'кроссовки', 'кроссы', 'снікерси', 'сникерсы', 'сникерс'];
let shoes_5 = ['Балетки', 'Драйверы', 'Лодочки', 'Лофери', 'Лоферы', 'Мокасини', 'Мокасины', 'Сліпери', 'Слиперы', 'Слипоны', 'Эспадрильи', 'Криперы', 'балетки', 'драйверы', 'лодочки', 'лофери', 'лоферы', 'мокасини', 'мокасины', 'сліпери', 'слиперы', 'слипоны', 'эспадрильи', 'криперы'];
let shoes_6 = ['Оксфорди', 'Оксфорды', 'Дербі', 'Дерби', 'Броги', 'оксфорди', 'оксфорды', 'дербі', 'дерби', 'броги'];
let shoes_7 = ['Сабо', 'Мюлі', 'Мюли', 'Бабуші', 'Бабуши', 'сабо', 'мюлі', 'мюли', 'бабуші', 'бабуши'];
let shoes_8 = ['Сандалі', 'Сандалии', 'Римлянки', 'сандалі', 'сандалии', 'римлянки'];
let shoes_9 = ['Ботфорты', 'Ботфорт', 'Полусапог', 'Чоботи', 'Сапог-чулок', 'Сапоги', 'Сапог', 'Унты', 'ботфорты', 'ботфорт', 'полусапог', 'чоботи', 'сапог-чулок', 'сапоги', 'сапог', 'унты'];
let shoes_10 = ['Туфлі', 'Туфли', 'Туфель', 'туфлі', 'туфли', 'туфель'];
let shoes_11 = ['Шльопанці', 'Шлёпки', 'Шлепки', 'Шлепанцы', 'Вьетнамки', 'Тапочки', 'шльопанці', 'шлёпки', 'шлепки', 'шлепанцы', 'вьетнамки', 'тапочки'];

let accessories_1 = ['Бейсболка', 'Капелюх', 'Шляпа', 'Кепка', 'Панама', 'Шапка', 'Повязка', 'Берет', 'бейсболка', 'капелюх', 'шляпа', 'кепка', 'панама', 'шапка', 'повязка', 'берет'];
let accessories_2 = ['Кардхолдер', 'Візитниця', 'Визитница', 'кардхолдер', 'візитниця', 'визитница'];
let accessories_3 = ['Клатч', 'Косметичка', 'Папка', 'Б\'юті-кейс', 'Бьютикейс', 'клатч', 'косметичка', 'папка', 'б\'юті-кейс', 'бьютикейс'];
let accessories_4 = ['Гаманець', 'Кошелек', 'Портмоне', 'гаманець', 'кошелек', 'портмоне'];
let accessories_5 = ['Окуляри', 'Очки', 'окуляри', 'очки'];
let accessories_6 = ['Рукавиці', 'Перчатки', 'Рукавички', 'рукавиці', 'перчатки', 'рукавички'];
let accessories_7 = ['Пояс', 'Ремінь', 'Ремень', 'пояс', 'ремінь', 'ремень'];
let accessories_8 = ['Плед', 'Шаль', 'Шарф', 'Хустка', 'Платок', 'Парео', 'плед', 'шаль', 'шарф', 'хустка', 'платок', 'парео'];
let accessories_9 = ['Сумка', 'Рюкзак', 'Портфель', 'Чемодан', 'Борселло', 'сумка', 'рюкзак', 'портфель', 'чемодан', 'борселло'];
let accessories_10 = ['Бабочка', 'Галстук', 'бабочка', 'галстук'];
let accessories_11 = ['Браслет', 'Каблучка', 'Кольцо', 'Кольє', 'Колье', 'Ланцюжок', 'Цепочка', 'Намисто', 'Бусы', 'Сережки', 'Серьги', 'Шпилька', 'Заколка', 'Ожерелье', 'Підвіска', 'Подвеска', 'Чокер', 'Украшение', 'Украшение_', 'Обруч', 'Клипсы', 'браслет', 'каблучка', 'кольцо', 'кольє', 'колье', 'ланцюжок', 'цепочка', 'намисто', 'бусы', 'сережки', 'серьги', 'шпилька', 'заколка', 'ожерелье', 'підвіска', 'подвеска', 'чокер', 'украшение', 'украшение_', 'обруч', 'клипсы'];
let accessories_12 = ['Ключниця', 'Ключница', 'Брелок', 'Чехол', 'ключниця', 'ключница', 'брелок', 'чехол'];
...
function changeTags(tags) {
    ...
    switch (true) { //check if tags contains some values
        ...
        case clothes_9.some(closthesValue => tags.includes(closthesValue)):
            newTags = tags.replace(clothes_9.find(closthesValue => tags.includes(closthesValue)),'') + ',одежда,топы_блузы_футболки';
            break;
